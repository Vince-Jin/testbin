...
function toggleModel() {
    ...
    if (modelSwitch.checked) {
        currentModel_30year = 'model2'; // Switch to model 2
        console.log('Switched to Model 2');
    } else {
        currentModel_30year = 'model1'; // Switch to model 1
        console.log('Switched to Model 1');
    }
    
    loadModelData(currentModel_30year); // Ensure beta coefficients are reloaded when switching models
...
window.onload = function () {
    ...
    currentModel_30year = 'model1'; // Set the default model
    loadModelData(currentModel_30year); // Load beta coefficients for Model 1
